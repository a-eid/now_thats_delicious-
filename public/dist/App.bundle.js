...
function ajaxHeart(e) {
  ...
  e.preventDefault();
  _axios2.default.post(e.target.action).then(function (res) {
...
var searchHtml = function searchHtml(stores) {
  return stores.map(function (store, i) {
    return "\n      <a href=/store/" + store.slug + " class=\"search__result " + (i == 0 && "search__result--active" || "") + "\"> \n        <strong>" + store.name + "</strong> \n      </a>\n    ";
  }).join("");
};

exports.default = function (search) {
  if (!search) return;
  var searchInput = (0, _bling.$)(".search__input");
  var searchResults = (0, _bling.$)(".search__results");
  ...
  searchInput.on("keyup", function (e) {
    if ([38, 40, 13].indexOf(e.keyCode) < 0 || !(0, _bling.$)(".search__results").children.length) return;

    var selected = (0, _bling.$)(".search__results > .search__result--active");
    ...
    var searchResults = (0, _bling.$)(".search__results");
    var elements = searchResults.children;

    if (e.keyCode == 40) {
      var nextSibling = selected.nextElementSibling;
      if (nextSibling) {
        selected.classList.remove("search__result--active");
        nextSibling.classList.add("search__result--active");
        selected = (0, _bling.$)(".search__results > .search__result--active");
      } else {
        selected.classList.remove("search__result--active");
    ...
    if (e.keyCode == 38) {
      var previousSibling = selected.previousSibling.previousSibling;
      if (previousSibling) {
        selected.classList.remove("search__result--active");
        ...
        selected = (0, _bling.$)(".search__results > .ssearch__result--active");
      }
    }
  });
};
